<?php
    ...
    include('../db.php');
    $id = $_GET['id'];
    $sql=  mysqli_query($con, "SELECT * FROM series WHERE id=$id") or die(mysqli_error($con));
    if($sql) {
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="name" placeholder="Movie Name" name="name" value="<?php echo $name?>">      
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="text" class="form-control" id="episode" placeholder="episode" name="episode" value="<?php echo $episode?>">
                        ...
                        <div class="col-12">
                            <hr>
                            <button class="btn btn-primary" type="submit" name="editSeries">Save</button>
                        </div>
            </form>
    </div>
    </aside>
